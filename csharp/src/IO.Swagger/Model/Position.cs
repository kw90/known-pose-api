...
namespace IO.Swagger.Model
{
        ...
        public partial class Position :  IEquatable<Position>, IValidatableObject
    {
        ...
        public Position(double? x = default(double?), double? y = default(double?), double? z = default(double?))
        {
            ...
            if (z == null)
            {
                throw new InvalidDataException("z is a required property for Position and cannot be null");
            }
            else
            {
                this.Z = z;
